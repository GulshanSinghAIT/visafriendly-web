...
const JobAlertsPage = () => {
  ...
  return (
    <div className={`${styles.mainContainer} bg-white rounded-lg border-[1px] border-[#D9D9D9]`}>
      
        <header className="flex justify-between items-center">
          <h1 className="text-2xl text-start font-semibold">Manage Job Alerts</h1>
          <button
            ...
            alerts.map((alert) => (
              <JobAlertCard
                ...
                alert={{
                  ...
                  frequency: `Frequency: ${alert.frequency || "Daily"

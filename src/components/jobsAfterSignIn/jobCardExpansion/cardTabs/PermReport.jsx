...
import PermSponsorModal from './PermSponsorModal';

const PermReport = ({ companyName }) => {
    ...
    return (
        <div className="w-full max-w-none py-4 bg-white overflow-y-auto max-h-96 scrollbar-hide">
            ...
            <div className="flex justify-between items-center mb-6">
                <h2 className="text-xl font-semibold text-gray-900">PERM Report</h2>
                <button 
                    onClick={() => setIsModalOpen(true)}
                    className="text-blue-600 hover:text-blue-800 font-medium text-sm"
                >
                    View PERM Sponsor Case
                </button>
            </div>
